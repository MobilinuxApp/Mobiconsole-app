...
final class TermuxInstaller {
    ...
    private static URL determineZipUrl() throws MalformedURLException {
        ...
        String url = "https://github.com/MobilinuxApp/Mobiconsole-app/blob/main/Bootstraps/bootstrap-" + archName + ".zip?raw=true";
        //https://github.com/MobilinuxApp/Mobiconsole-app/blob/main/Bootstraps/bootstrap-aarch64.zip?raw=true
        return new URL(url);
    }
